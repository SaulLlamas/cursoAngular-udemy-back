/**
 * @summary Servicio Hospitals
 * @description Se encarga de realizar las operaciones relacionadas con los hospitales en la base de datos
...
/**
 * @description Debuelve todos los hospitales
 * @param request
 * @param response
 */
module.exports.getAllHospitals = (request,response)=>{
...
/**
 * @description Debuelve todos los hospitales paginados
 * @param request
 * @param response
 */
module.exports.paginateHospitals = (request ,response)=> {
 ...
 * @param response
 */
module.exports.updateHospital = (request,response)=>{
...
/**
 * @description Guarda un hospital en la base de datos
 * @param request
 * @param response
 */
module.exports.insertHospital = (request , response)=>{
    /**
...
/**
 * @description Borra un hopital de la base de datos
 * @param request
 * @param response
 */
module.exports.deleteHospital = (request,response)=>{
